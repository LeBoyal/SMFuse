...
flags = tf.app.flags
flags.DEFINE_integer("epoch", 4000, "Number of epoch [10]")
flags.DEFINE_integer("batch_size", 32, "The size of batch images [128]")
flags.DEFINE_integer("image_size", 84, "The size of image to use [33]")
flags.DEFINE_integer("label_size", 84, "The size of label to produce [21]")
